<div class="page-header">
    <h2><?= t('Modelo de Chamado') ?></h2>
</div>
<form method="post" action="<?= $this->url->href('TemplateController', 'save', array('plugin' => 'TaskTemplate', 'project_id' => $project['id'])) ?>" autocomplete="off">
    <?= $this->form->csrf() ?>
    ...
    <?= $this->form->checkbox('default', t('Modelo Padrão'), 1, false) ?>
